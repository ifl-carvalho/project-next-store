...
export const Policies: NextPage = () => {
  return (
    <div className={styles.policiesPage}>
      ...
      <div className={styles.policies}>
        ...
        <p>
          A sua privacidade é importante para nós. É política do &quot;Nome do seu Site&quot;
          respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no
          site <a href="/">&quot;Nome do seu Site&quot;</a>, e outros sites que possuímos e
          operamos.
        </p>
        <p>
          Solicitamos informações pessoais apenas quando realmente precisamos delas para lhe
          fornecer um serviço. Fazendo-o por meios justos e legais, com o seu conhecimento e
        ...
        &#xa0;
        <h2>Política de Cookies &quot;Nome do seu Site&quot;</h2> <h3>O que são cookies?</h3>
        &#xa0;
        <p>
          ...
          descreve quais informações eles coletam, como as usamos e por que às vezes precisamos
          armazenar esses cookies. Também compartilharemos como você pode impedir que esses cookies
        ...
        <p>
          ...
          recomendável que você deixe todos os cookies se não tiver certeza se precisa ou não deles,
        ...
        <ul>
          ...
          <li>
            ...
            <br />
            <br /> Se você criar uma conta conosco, usaremos cookies para o gerenciamento do
            processo de inscrição e administração geral. Esses cookies geralmente serão excluídos
          ...
          <li>
            ...
            <br />
            <br /> Utilizamos cookies quando você está logado, para que possamos lembrar dessa ação.
            Isso evita que você precise fazer login sempre que visitar uma nova página. Esses
            cookies são normalmente removidos ou limpos quando você efetua logout para garantir que
            você possa acessar apenas a recursos e áreas restritas ao efetuar login.
            <br />
            <br />
            &#xa0;
          </li>
          ...
          <li>
            ...
            <br />
            <br /> Este site oferece serviços de assinatura de boletim informativo ou e-mail e os
            cookies podem ser usados para lembrar se você já está registrado e se deve mostrar
            determinadas notificações válidas apenas para usuários inscritos / não inscritos.
            <br />
            <br />
            &#xa0;
          </li>
          ...
          <li>
            ...
            <br />
            <br /> Este site oferece facilidades de comércio eletrônico ou pagamento e alguns
            cookies são essenciais para garantir que seu pedido seja lembrado entre as páginas, para
            que possamos processá-lo adequadamente.
            <br />
            <br />
            &#xa0;
          </li>
          ...
          <li>
            ...
            <br />
            <br /> Periodicamente, oferecemos pesquisas e questionários para fornecer informações
          ...
          <li>
            ...
            <br />
            <br /> Quando você envia dados por meio de um formulário como os encontrados nas páginas
            de contacto ou nos formulários de comentários, os cookies podem ser configurados para
          ...
          <li>
            ...
            <br />
            <br /> Para proporcionar uma ótima experiência neste site, fornecemos a funcionalidade
            para definir suas preferências de como esse site é executado quando você o usa. Para
            lembrar suas preferências, precisamos definir cookies para que essas informações possam
            ser chamadas sempre que você interagir com uma página for afetada por suas preferências.
            <br />
            &#xa0;
          </li>
          &#xa0;
        ...
        <p>
          ...
          seção a seguir detalha quais cookies de terceiros você pode encontrar através deste site.
        </p>
        &#xa0;
        <ul>
          &#xa0;
          <li>
            ...
            difundidas e confiáveis da Web, para nos ajudar a entender como você usa o site e como
            podemos melhorar sua experiência. Esses cookies podem rastrear itens como quanto tempo
            você gasta no site e as páginas visitadas, para que possamos continuar produzindo
            conteúdo atraente.&#xa0;
          </li>
          &#xa0;
        </ul>
        ...
        <ul>
          &#xa0;
          <li>
            &#xa0; As análises de terceiros são usadas para rastrear e medir o uso deste site, para
            que possamos continuar produzindo conteúdo atrativo. Esses cookies podem rastrear itens
            como o tempo que você passa no site ou as páginas visitadas, o que nos ajuda a entender
            como podemos melhorar o site para você.
          </li>
          &#xa0;
          <li>
            &#xa0; Periodicamente, testamos novos recursos e fazemos alterações subtis na maneira
            como o site se apresenta. Quando ainda estamos testando novos recursos, esses cookies
          ...
          <li>
            ...
            quantos visitantes de nosso site realmente compram e, portanto, esse é o tipo de dados
            que esses cookies rastrearão. Isso é importante para você, pois significa que podemos
            fazer previsões de negócios com precisão que nos permitem analisar nossos custos de
        ...
        <p>
          ...
          &quot;Nome do seu Site&quot; oferece no site e com caráter enunciativo, mas não
          limitativo:
        </p>
        &#xa0;
        <ul>
          ...
          &#xa0;
          <li>
            B) Não difundir propaganda ou conteúdo de natureza racista, xenofóbica, ou homofóbica,
            casas de apostas online (ex.: ), jogos de sorte e azar, qualquer tipo de pornografia
            ilegal, de apologia ao terrorismo ou contra os direitos humanos;
          </li>
          &#xa0;
          <li>
            C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do &quot;Nome
            do seu Site&quot;, de seus fornecedores ou terceiros, para introduzir ou disseminar
        ...
        &#xa0;
        <p>
          Esta política é efetiva a partir de <strong>April</strong>/<strong>2021</strong>.
        </p>
      </div>
