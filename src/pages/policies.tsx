  ...
  return (
    <div className={styles.policies}>
      ...
      <p>
        ...
        site <a href="/">&quot;Nome do seu Site&quot;</a>, e outros sites que possuímos e operamos.
      </p>
      <p>
      ...
      <p>
        ...
        completamente a funcionalidade e os recursos que eles adicionam a este site. É recomendável
        que você deixe todos os cookies se não tiver certeza se precisa ou não deles, caso sejam
        usados parafornecer um serviço que você usa.
      </p>{' '}
      ...
      <ul>
        ...
        <li>
          ...
          <br />
          <br /> Se você criar uma conta connosco, usaremos cookies para o gerenciamento do processo
          de inscrição e administração geral. Esses cookies geralmente serão excluídos quando você
        ...
        <li>
          ...
          são normalmente removidos ou limpos quando você efetua logout para garantir que você possa
        ...
        <li>
          ...
          <br />
          <br /> Este site oferece facilidades de comércio eletrônico ou pagamento e alguns cookies
        ...
        <li>
          ...
          precisão. Essas pesquisas podem usar cookies para lembrar quem já participou numa pesquisa
      ...
      <ul>
        ...
        <li>
          ...
          previsões de negócios com precisão que nos permitem analizar nossos custos de publicidade
          e produtos para garantir o melhor preço possível.
        </li>{' '}
      </ul>{' '}
      <h3>Compromisso do Usuário</h3>{' '}
      <p>
        O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o &quot;Nome
        do seu Site&quot; oferece no site e com caráter enunciativo, mas não limitativo:
      </p>{' '}
      <ul>
        {' '}
        <li>
        ...
        <li>
          ...
          do seu Site&quot;, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus
