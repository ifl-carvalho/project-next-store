      ...
      <div className={styles.policiesPage}>
        ...
        <div className={styles.policies}>
          ...
          <p>
            ...
            deles, caso sejam usados parafornecer um serviço que você usa.
          </p>{' '}
          ...
          <ul>
            ...
            <li>
              ...
              <br />
              <br /> Se você criar uma conta connosco, usaremos cookies para o gerenciamento do
            ...
            <li>
              ...
              <br />
              <br /> Utilizamos cookies quando você está logado, para que possamos lembrar dessa
              ação. Isso evita que você precise fazer login sempre que visitar uma nova página.
            ...
            <li>
              ...
              cookies são essenciais para garantir que seu pedido seja lembrado entre as páginas,
              para que possamos processá-lo adequadamente.
              <br />
              <br />{' '}
            </li>{' '}
            <li>
            ...
            <li>
              ...
              <br />
              <br /> Quando você envia dados por meio de um formulário como os encontrados nas
              páginas de contacto ou nos formulários de comentários, os cookies podem ser
          ...
          <p>
            ...
            seção a seguir detalha quais cookies de terceiros você pode encontrar através deste
            site.
          </p>{' '}
          <ul>
            {' '}
          ...
          <ul>
            ...
            <li>
              ...
              site se apresenta. Quando ainda estamos testando novos recursos, esses cookies podem
              ser usados para garantir que você receba uma experiência consistente enquanto estiver
              no site, enquanto entendemos quais otimizações os nossos usuários mais apreciam.
            </li>{' '}
            <li>
              {' '}
              À medida que vendemos produtos, é importante entendermos as estatísticas sobre quantos
              visitantes de nosso site realmente compram e, portanto, esse é o tipo de dados que
              esses cookies rastrearão. Isso é importante para você, pois significa que podemos
          ...
          <ul>
            ...
            <li>
              C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do
              &quot;Nome do seu Site&quot;, de seus fornecedores ou terceiros, para introduzir ou
